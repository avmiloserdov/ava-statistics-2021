...
* [Методы анализа данных](#Методы анализа данных)
    ...
    * [Факторный анализ](#factor - факторный анализ)
* [Вспомогательные скрипты](#Вспомогательные скрипты)
    ...
    * [Подсчет количества видов растений определленных групп](# Подсчет количества видов растений определленных груп)
...
### Подсчет количества видов растений определленных групп

Скрипт classify_by_groups осуществляет подсчет количества видов растений, относящихся к тому или иному отделу (мхи, сосудистые, лишайники, печеночники) и выводит результаты в консоль.
...
После считывания аргументов из консоли происходит формирование вектора отсортированного вектора 
